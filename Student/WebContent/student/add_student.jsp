		...
		<div class="content">
			<s:form action="add_student.action" method="post"
				...
				<div class="line">
					<div class="bottom">
						<label for="name">姓名&gt;</label> <input type="text" class="text"
							name="student.name" id="name" /> <label for="name" class="msg"><s:property value="fieldErrors['student.name'][0]"/></label>
					</div>
				</div>
				<!-- 性别 -->
				<div class="line">
					<div class="bottom">
						<label>性别&gt;</label> <input type="radio" class="text"
							name="student.sex" value="男" checked="checked" /><label>男</label>
						<input type="radio" class="text" name="student.sex" value="女" /><label>女</label>
				...
				<div class="line">
					<div class="bottom">
						<label>生日&gt;</label>
						<input type="text" name="student.birth"  id="birth"/>
						<label class="msg"><s:property value="fieldErrors['student.sex'][0]"/></label>
					</div>
				</div>
				<!-- 爱好 -->
