							...
							<div class="x_panel" style="height: 600px;">
								...
								<div>
									<form class="form-horizontal form-label-left"
										action="/SHTest/manage/add_Enterprise.action" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input id="name" class="form-control col-md-7 col-xs-12"
													data-validate-length-range="1" name="name"
													placeholder="公司名称" required="required" type="text">
											</div>
										</div>
										<div class="item form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input id="address" class="form-control col-md-7 col-xs-12"
													data-validate-length-range="1" name="address"
													placeholder="公司地址" required="required" type="text">
											</div>
										</div>
										<div class="item form-group">
                                            <label
												class="control-label col-md-3 col-sm-3 col-xs-12"
												for="number">公司规模 <span class="required">*</span>
                                            </label>
                                            <div
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="email" id="email" name="email"
													required="required" placeholder="HR 邮箱"
													class="form-control col-md-7 col-xs-12">
											</div>
										</div>
										<div class="item form-group">
