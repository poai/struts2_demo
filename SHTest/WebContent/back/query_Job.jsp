										...
										<div class="x_panel">
											<div class="x_content">
												<table class="table table-hover">
													...
													<tbody>
														<s:iterator value="#request.jobs">
															<tr>
																<th scope="row"><s:property value="id"/> </th>
																<td><s:property value="title"/></td>
																<td><s:property value="sdate"/></td>
																<td>
																<s:a href="/SHTest/manage/editor_Job.action?id=%{id}">编辑</s:a>
																<s:a href="/SHTest/manage/delete_Job.action?id=%{id}">删除</s:a>
																</td>
															</tr>
														</s:iterator>
													</tbody>
												...
												<div>
													...
													&nbsp;&nbsp;
													<a href="${basepath}manage/query_Job.action?page=1">首页</a> 
													<a href="${basepath}manage/query_Job.action?page=${requestScope.page-1}">上一页</a> 
													<a href="${basepath}manage/query_Job.action?page=${requestScope.page+1}">下一页</a> 
													<a href="${basepath}manage/query_Job.action?page=${requestScope.total}">尾页</a>
												</div>
											</div>
										</div>
									</div>
