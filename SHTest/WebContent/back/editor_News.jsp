...
<script type="text/javascript" charset="utf-8"
	src="${path1}ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8"
	src="${path1}ueditor.all.min.js">
	
</script>
<script type="text/javascript" charset="utf-8"
	src="${path1}lang/zh-cn/zh-cn.js"></script>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> 热点新闻 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu" style="display: none">
										<li><a href="${basepath}back/add_News.jsp">添加热点新闻</a> <li><a href="${basepath}manage/query_News.action">查询热点新闻</a>
							...
							<div class="x_panel" style="height: 600px;">
								...
								<div>
									<form novalidate="" id="demo-form2" data-parsley-validate=""
										action="/SHTest/manage/save_News.action"
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12 "
												for="first-name" style="width: 60px; text-align: left;">标签
												<span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<s:select data-parsley-id="5570" id="heard"
													list="{'最新动态','公务员','创业园地','通知','就业指导','专家答疑','就业政策','院校直通','社团活动'}"
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<s:textfield data-parsley-id="7190" required="required"
													class="laydate-icon" value="%{sdate}" type="text"
													name="sdate" id="sdate" />
												<ul id="parsley-id-7190" class="parsley-errors-list"></ul>
											</div>
										</div>
										<div>
											<script id="editor" name="content" type="text/plain"
												style="width:950px;height:300px;">${content}</script>
										</div>
