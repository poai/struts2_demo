										...
										<div class="x_panel">
											<div class="x_content">
													...
													<tbody>
														<s:iterator value="#request.news">
															<tr>
																...
																<td>
																<s:a href="/SHTest/manage/editor_News.action?id=%{id}">编辑</s:a>
																<s:a href="/SHTest/manage/delete_News.action?id=%{id}">删除</s:a>
																</td>
															</tr>
														</s:iterator>
													</tbody>
												...
												<div>
													...
													&nbsp;&nbsp;
													<a href="${basepath}manage/query_News.action?page=1">首页</a> 
													<a href="${basepath}manage/query_News.action?page=${requestScope.page-1}">上一页</a> 
													<a href="${basepath}manage/query_News.action?page=${requestScope.page+1}">下一页</a> 
													<a href="${basepath}manage/query_News.action?page=${requestScope.total}">尾页</a>
												</div>
											</div>
										</div>
									</div>
