							...
							<div class="x_panel">
								...
								<div>
									<form novalidate="" id="demo-form2" data-parsley-validate=""
										action="/SHTest/manage/add_News.action"
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<s:select data-parsley-id="5570" id="heard" list="{'最新动态','公务员','创业园地','通知','就业指导','专家答疑','就业政策','院校直通','社团活动'}"
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input data-parsley-id="7190" required="required"
													class="laydate-icon" type="text" name="sdate" id="sdate">
												<ul id="parsley-id-7190" class="parsley-errors-list"></ul>
											</div>
										</div>
										<div>
